...
namespace TrainworksModdingTools.Managers
{
    public class ProviderManager : IClient
    {
        ...
        public void NewProviderAvailable(IProvider newProvider)
        {
            ...
            TrainworksModdingTools.Trainworks.Log(BepInEx.Logging.LogLevel.Debug, newProvider.GetType().AssemblyQualifiedName + " Was Registered to ProviderManager");
        }
