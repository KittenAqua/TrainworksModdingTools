...
namespace TrainworksModdingTools.AssetConstructors
{
    public class CharacterAssetConstructor : TrainworksModdingTools.Interfaces.IAssetConstructor
    {
        ...
        private static GameObject CreateCharacterGameObject(AssetReference assetRef, Sprite sprite)
        {
            ...
            */
            ...
            /*
            framework.Log(BepInEx.Logging.LogLevel.All, "We're doing the code!");
            var skeletonData = framework.TrainworksBundle.LoadAsset("assets/PNGTemplate.prefab") as GameObject;
